...
describe('Ensure Sharp Processing Works', () => {
    ...
    const testOutputPath = 'src/server/tests/testFiles/Apple Macbook Pro.jpg - modified.jpg';
    it('Resizes an image with specified width and height', async () => {
        const image = await transform(testFilePath, testWidth, testHeight, testOutputPath);
